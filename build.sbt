...
lazy val root = (project in file("."))
  .settings(
    ...
    libraryDependencies += "org.http4s" %% "http4s-core" % "1.0.0-M39",
    libraryDependencies += "org.http4s" %% "http4s-dsl" % "1.0.0-M39",
    libraryDependencies += "org.http4s" %% "http4s-ember-server" % "1.0.0-M39",
    libraryDependencies += "org.http4s" %% "http4s-ember-client" % "1.0.0-M39",
    libraryDependencies += "org.http4s" %% "http4s-circe" % "1.0.0-M39",
